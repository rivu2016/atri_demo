...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox6": {
      "custom": {
        "text": "Hi! I’m Swarnava, a Web Developer based in Delhi. I create user-friendly interfaces for fast-growing startups."
      },
      "callbacks": {
        "onClick": [
          {
        ...
        "onClick": [
          {
            "navigate": {
              "type": "external",
              "url": "https://drive.google.com/file/d/13BqM4tcwt_gLB2q5oqWJogEbFn3yHYh6/view?usp=share_link",
              "target": "_blank"
            }
          }
        ]
    ...
    "TextBox199": {
      "custom": {
        "text": "© All rights reserved. Made with ❤️ using Atri Framework, by Swarnava Banerjee."
      },
      "callbacks": {
        "onClick": [
          {
